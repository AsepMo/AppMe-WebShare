...
import com.appme.story.engine.graphics.drawables.ProgressDrawable;
...
public class LoaderView extends LinearLayout implements View.OnClickListener {
    ...
    private void updateToFileView() {
        imageView.setImageResource(com.appme.filepicker.utils.FileUtil.getFileIcon(fileData.getFileName()));
